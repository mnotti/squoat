...
class MainSquirrel: SKSpriteNode {
    ...
    override init(texture: SKTexture!, color: SKColor, size: CGSize) {
        ...
        self.yScale = 0.2
        self.zPosition = 3
        self.physicsBody = SKPhysicsBody(texture: SKTexture(imageNamed: "mainSquirrel"), size: self.size)
